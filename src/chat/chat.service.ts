...
export class ChatService {
    constructor(@InjectModel(ChatModel) private readonly ChatModel: ModelType<ChatModel>, @InjectModel(ReguestsModel) private readonly ReguestsModel: ModelType<ReguestsModel>,
    ...
    async acceptFriends(dto: RequestFriendsDto) {
        const oldRequest = await this.ReguestsModel.findOneAndUpdate({
            sender: dto.sender,
            taker: dto.taker }, { accept: dto.accept })
